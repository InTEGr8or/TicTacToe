...
var Game = ({
    ...
    fillNullSquare: function (rowId, colId) {
        Board.board[rowId][colId] = computer;
        Board.board[rowId][colId].readonly = true;
        Board.render("#ticTacToe");
        return { rowId: rowId, colId: colId, value: Board.board[rowId][colId] };
    }
});
